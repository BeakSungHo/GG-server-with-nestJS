...
exports.MainFormService = void 0;
const common_1 = require("@nestjs/common");
const Posts_repository_1 = require("./Repository/Posts.repository");
let MainFormService = class MainFormService {
    ...
    createWSPost(createWSPost) {
        return this.postRepository.createWSPost(createWSPost);
    }
};
MainFormService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [Posts_repository_1.PostRepository])
], MainFormService);
exports.MainFormService = MainFormService;
//# sourceMappingURL=main-form.service.js.map